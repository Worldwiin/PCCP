...
public class Login extends javax.swing.JFrame {
    ...
    private void btnLoginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLoginActionPerformed
        ...
        if (counter == 3) {
            JOptionPane.showMessageDialog(this, "Valid Password : System Successfully Login","Welcome Message", JOptionPane.INFORMATION_MESSAGE);
            this.dispose();
            new MainMDIForm().setVisible(true);
        } else {
            JOptionPane.showMessageDialog(this, "Invalid Password : System Failed for Login","Error", JOptionPane.ERROR_MESSAGE);
            Details.counter = 0;
        }
